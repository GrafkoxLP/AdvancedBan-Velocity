...
/**
 * Originally created by Leoko (2016). Maintained by Leon (Grafkox_LP).
 */
public class BungeeMethods implements MethodInterface {
    ...
    public void setupMetrics() {
        ...
        metrics.addCustomChart(new org.bstats.charts.SimplePie("MySQL", () -> DatabaseManager.get().isUseMySQL() ? "yes" : "no"));
    }
    ...
    public void runSync(Runnable rn) {
        rn.run(); // Bungee has no main thread, just runs immediately
    }
