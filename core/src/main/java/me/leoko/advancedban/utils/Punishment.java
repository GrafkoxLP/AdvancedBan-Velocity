...
import me.leoko.advancedban.manager.DiscordManager;
...
public class Punishment {
    ...
    public void create(boolean silent) {
        ...
        DiscordManager.get().onPunish(this);
    ...
    public void delete(String who, boolean massClear, boolean removeCache) {
        delete(who, massClear, removeCache, false);
    }

    public void delete(String who, boolean massClear, boolean removeCache, boolean automatic) {
        if (getType() == PunishmentType.KICK) {
        ...
        DiscordManager.get().onRevoke(this, automatic);
    }
