...
public interface MethodInterface {
    ...
    /**
     * Load an arbitrary YAML file using the platform-native loader.
     * The returned object is compatible with {@link #getString(Object, String)} and friends.
     *
     * @param file the YAML file
     * @return the loaded config object, or null on failure
     */
    Object loadYamlFile(File file);
}